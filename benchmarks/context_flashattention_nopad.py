...
from dlblas.kernels.context_flashattention_nopad import (
...
def test():
    ...
    context_attention_fwd_no_prompt_cache(q, q_rope, kv, kv_rope, o, b_start_loc, b_seq_len, max_input_len, softmax_scale)
    ...
    def bench_fn(op, provider, device=device_):
        ...
        if "triton" in provider:
            fn = lambda: context_attention_fwd_no_prompt_cache(q, q_rope, kv, kv_rope, o, b_start_loc, b_seq_len, max_input_len, softmax_scale)
