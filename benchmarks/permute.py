...
try:
    from dlBLAS.tests.kernels.permute.triton_ops import permute_triton, unpermute_triton
    from dlBLAS.tests.kernels.permute.permute_triton import permute_torch, unpermute_torch
...
def permute_topK_test(
    ...
    permute_output, sorted_indices = permute_torch(permute_input, indices, num_topK, is_fp8)
    nvtx.range_pop()
    ...
    unpermute_output = unpermute_torch(unpermute_input, sorted_indices, probs=probs, merge_factor=num_topK)
