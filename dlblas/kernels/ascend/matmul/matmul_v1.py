...
from dlblas.utils.op_helper import grouped_launch_swizzling
...
def matmul_kernel(
    ...
    for block_idx in range (pid, NUM_BLOCKS, num_cores):
        task_m_idx, task_n_idx = grouped_launch_swizzling(block_idx, NUM_BLOCKS_M, NUM_BLOCKS_N, BLOCK_TRESHHOLD)
