...
class TestFusedMoeBlockedFP8:
    ...
    def gt(self, hidden_states, w1, w2, topk_weights, topk_idx, top_k, renormalize):
        from dlblas.kernels.fused_moe import fused_moe
    ...
    def test_fused_moe(self, states_quanted, states_scale, w1_quant, w1_scale, w2_quant, w2_scale, topk_weights,
        ...
        output = dlblas_fused_moe_blocked_fp8(states_quanted,
                                              states_scale,
                                              w1_quant,
                                              w1_scale,
                                              w2_quant,
    ...
    @torch.inference_mode()
    def test_fused_moe_ep_size8(self, states_quanted, states_scale, w1_quant, w1_scale, w2_quant, w2_scale, topk_weights,
                                topk_idx, top_k, renormalize, gt):
        from dlblas.layers.moe.kernels.blocked_fp8_fused_moe import dlblas_fused_moe_blocked_fp8
        output = dlblas_fused_moe_blocked_fp8(states_quanted,
                                              states_scale,
